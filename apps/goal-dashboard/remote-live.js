(() => {
  ...
  window.__stephanosRemoteGoalDashboardV1 = { parseBeaconComment, latestBeacon, remoteAutonomyBuildTrack, formatAutonomyBuildTrack, buildProjection, refreshRemote };
