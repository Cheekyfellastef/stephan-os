  ...
  return (
    <section className="debug-console panel">
      ...
      <div className="debug-grid">
        <div><strong>Request</strong><pre>{JSON.stringify({ request_id: debugData.response_payload?.debug?.request_id, parsed_command: debugData.parsed_command, requested_provider: debugData.requested_provider || debugData.request_payload?.provider, selected_provider: debugData.selected_provider, actual_provider_used: debugData.actual_provider_used }, null, 2)}</pre></div>
