...
test('MissionConsoleTile renders compact agent task verification return summary from projection fields', async () => {
  ...
  const requiredLabels = [
    ...
    'openclaw adapter connection mode:',
    'openclaw adapter connection state:',
    'openclaw adapter endpoint configured:',
    'openclaw adapter endpoint scope:',
    'openclaw adapter health check:',
    'openclaw adapter handshake:',
    'openclaw capability trial:',
    'openclaw proposal packet:',
    'openclaw review queue:',
    'openclaw codex export:',
    'openclaw controlled execution gate:',
    'openclaw adapter connection ready:',
    'openclaw adapter connection execution allowed:',
    'openclaw adapter connection blocker:',
    'openclaw adapter connection next action:',
    'openclaw adapter readiness:',
    'openclaw adapter mode:',
    'openclaw adapter stub status:',
    'openclaw adapter stub health:',
    'openclaw adapter stub connection:',
    'openclaw adapter stub execution disabled:',
    'openclaw adapter stub next action:',
