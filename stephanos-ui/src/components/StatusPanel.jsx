...
export default function StatusPanel() {
  ...
  const supportSnapshot = buildSupportSnapshot({
    runtimeStatus: {
      ...
      lastSelectedProviderWarmupRetryEligible: String(lastExecutionMetadata?.selected_provider_warmup_retry_eligible ?? 'n/a'),
      lastSelectedProviderWarmupRetryApplied: String(lastExecutionMetadata?.selected_provider_warmup_retry_applied ?? 'n/a'),
      lastSelectedProviderWarmupRetryReason: lastExecutionMetadata?.selected_provider_warmup_retry_reason || 'n/a',
      lastSelectedProviderWarmupRetryTimeoutMs: String(lastExecutionMetadata?.selected_provider_warmup_retry_timeout_ms ?? 'n/a'),
      lastSelectedProviderWarmupRetryAttemptCount: String(lastExecutionMetadata?.selected_provider_warmup_retry_attempt_count ?? 'n/a'),
      lastSelectedProviderFirstAttemptElapsedMs: String(lastExecutionMetadata?.selected_provider_first_attempt_elapsed_ms ?? 'n/a'),
      lastSelectedProviderFinalAttemptElapsedMs: String(lastExecutionMetadata?.selected_provider_final_attempt_elapsed_ms ?? 'n/a'),
      lastSelectedProviderInitialFailureLayer: lastExecutionMetadata?.selected_provider_initial_failure_layer || 'n/a',
      lastSelectedProviderInitialFailureLabel: lastExecutionMetadata?.selected_provider_initial_failure_label || 'n/a',
      lastSelectedProviderInitialFailurePhase: lastExecutionMetadata?.selected_provider_initial_failure_phase || 'n/a',
      lastSelectedProviderInitialTimeoutCategory: lastExecutionMetadata?.selected_provider_initial_timeout_category || 'n/a',
      lastSelectedProviderFinalExecutionOutcome: lastExecutionMetadata?.selected_provider_final_execution_outcome || 'n/a',
      lastSelectedProviderFallbackAfterWarmupRetry: String(lastExecutionMetadata?.selected_provider_fallback_after_warmup_retry ?? 'n/a'),
