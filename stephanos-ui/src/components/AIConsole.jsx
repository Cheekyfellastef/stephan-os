    ...
    >
      <div className="mission-console-shell">
        ...
        <div className="api-banner ready">
          ...
          <span>PR Evidence: {lastExecutionMetadata?.pr_evidence_status || runtimeStatus?.prEvidenceStatus || 'none'} · Merge Recommendation: {lastExecutionMetadata?.pr_evidence_merge_readiness || runtimeStatus?.prEvidenceMergeReadiness || 'hold'} · Next Action: {lastExecutionMetadata?.pr_evidence_recommended_next_action || runtimeStatus?.prEvidenceRecommendedNextAction || 'paste PR evidence'}</span>
