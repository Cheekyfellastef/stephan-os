  ...
  useLayoutEffect(() => {
    ...
    const publishScrollDiagnostics = (overrides = {}) => {
      ...
      answerScrollDiagnosticsRef.current = {
        ...
        commandDeckLocalRevealResult: (previous.requested || 'no') === 'yes' ? (previous.completed === 'yes' ? ((previous.skipReason || 'none') === 'already-visible-confirmed' ? 'already-visible-confirmed' : 'yes') : 'no') : 'no',
        commandDeckLocalRevealReason: (previous.requested || 'no') === 'yes' ? (((previous.skipReason || 'none') === 'already-visible-confirmed') ? 'already-visible-confirmed' : ((previous.completed || 'no') === 'yes' ? 'revealed' : (previous.skipReason || 'none'))) : 'not-attempted',
      ...
      if (isCommandDeckOwner()) {
        ...
        publishCommandDeckLocalReveal({
          ...
          revealAssistantId: answerScrollDiagnosticsRef.current.commandDeckLocalRevealAssistantId || deliveryAnchoredAssistantAnswerId || latestAssistantAnswerId || 'none',
