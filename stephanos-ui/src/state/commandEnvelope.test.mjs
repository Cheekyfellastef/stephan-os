...
test('envelope attachment + projection covers chat context/provider/execution/support snapshot fields', () => {
  ...
  env = attachPrEvidenceToEnvelope(env, { status: 'parsed', prNumber: 123, repo: 'acme/stephan-os', checksStatus: 'failed', mergeReadiness: 'needs-proof', missingProof: ['browser'], recommendedNextAction: 'capture browser proof' });
