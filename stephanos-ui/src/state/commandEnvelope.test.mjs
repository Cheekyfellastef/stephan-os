...
test('envelope attachment + projection covers chat context/provider/execution/support snapshot fields', () => {
  ...
  env = attachPrEvidenceToEnvelope(env, { status: 'parsed', prNumber: 123, mergeReadiness: 'needs-proof', missingProof: ['browser'], recommendedNextAction: 'capture browser proof' });
