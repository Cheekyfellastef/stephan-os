...
export function buildSupportSnapshot({
  ...
  const lines = [
    ...
    `UI Reality AI Core Mission Console Present: ${asText(uiRealityStatus.uiRealityAiCoreMissionConsolePresent, 'no')}`,
    `UI Reality AI Core Mission Console Panel ID: ${asText(uiRealityStatus.uiRealityAiCoreMissionConsolePanelId, 'unknown')}`,
    `UI Reality AI Core Mission Console Force Open: ${asText(uiRealityStatus.uiRealityAiCoreMissionConsoleForceOpen, 'no')}`,
    `UI Reality Dedicated Mission Console Present: ${asText(uiRealityStatus.uiRealityDedicatedMissionConsolePresent, 'no')}`,
