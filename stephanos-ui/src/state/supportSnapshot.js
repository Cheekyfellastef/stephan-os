...
export function buildSupportSnapshot({
  ...
  const lines = [
    ...
    `Operator Context Model Status: ${asText(operatorCockpitProjection.operatorContextModel?.status, 'unavailable')}`,
    `Operator Context Model Stephan Role: ${Array.isArray(operatorCockpitProjection.operatorContextModel?.stephanRole) ? operatorCockpitProjection.operatorContextModel.stephanRole.join(' | ') : asText(operatorCockpitProjection.operatorContextModel?.stephanRole, 'none')}`,
    `Operator Context Model Project Direction: ${Array.isArray(operatorCockpitProjection.operatorContextModel?.projectDirection) ? operatorCockpitProjection.operatorContextModel.projectDirection.join(' | ') : asText(operatorCockpitProjection.operatorContextModel?.projectDirection, 'none')}`,
    `Operator Context Model Guardrails: ${Array.isArray(operatorCockpitProjection.operatorContextModel?.guardrails) ? operatorCockpitProjection.operatorContextModel.guardrails.join(' | ') : asText(operatorCockpitProjection.operatorContextModel?.guardrails, 'none')}`,
    `Operator Context Model Preferences: ${Array.isArray(operatorCockpitProjection.operatorContextModel?.preferences) ? operatorCockpitProjection.operatorContextModel.preferences.join(' | ') : asText(operatorCockpitProjection.operatorContextModel?.preferences, 'none')}`,
    `Operator Context Model Strategy: ${Array.isArray(operatorCockpitProjection.operatorContextModel?.strategy) ? operatorCockpitProjection.operatorContextModel.strategy.join(' | ') : asText(operatorCockpitProjection.operatorContextModel?.strategy, 'none')}`,
    `Operator Context Model Research Stance: ${Array.isArray(operatorCockpitProjection.operatorContextModel?.researchStance) ? operatorCockpitProjection.operatorContextModel.researchStance.join(' | ') : asText(operatorCockpitProjection.operatorContextModel?.researchStance, 'none')}`,
    `Operator Context Model Diagnostic Packet Available: ${asText(operatorCockpitProjection.operatorContextModel?.diagnosticPacketAvailable, 'no')}`,
    `Operator Context Model Contradiction Detected: ${asText(operatorCockpitProjection.operatorContextModel?.contradictionDetected, 'no')}`,
    `Operator Context Model Mutation Allowed: ${asText(operatorCockpitProjection.operatorContextModel?.mutationAllowed, 'no')}`,
    `Operator Context Model Automatic Browsing Allowed: ${asText(operatorCockpitProjection.operatorContextModel?.automaticBrowsingAllowed, 'no')}`,
    `Operator Context Model Codex Auto Dispatch Allowed: ${asText(operatorCockpitProjection.operatorContextModel?.codexAutoDispatchAllowed, 'no')}`,
    `Operator Context Model OpenClaw Mutation Locked: ${asText(operatorCockpitProjection.operatorContextModel?.openClawMutationLocked, 'yes')}`,
    `Operator Context Model Merge Safety: ${asText(operatorCockpitProjection.operatorContextModel?.mergeSafety, 'no / hold')}`,
    ...
    `Proof Concierge Render Owner: ${asText(operatorProofConcierge.renderOwner, 'unknown')}`,
    `Proof Concierge Render Source File: ${asText(operatorProofConcierge.renderSourceFile, 'unknown')}`,
    `Proof Concierge Render Branch: ${asText(operatorProofConcierge.renderBranch, 'unknown')}`,
    `Proof Concierge Rendered Next Proof: ${asText(operatorProofConcierge.renderedNextProof || operatorProofConcierge.nextProof, 'none')}`,
    `Proof Concierge Rendered Copy Label: ${asText(operatorProofConcierge.renderedCopyLabel || operatorProofConcierge.copyPacket?.label, 'none')}`,
    ...
    `Intent Intake Status: ${asText(operatorCockpitProjection.intentIntake?.intentIntakeStatus, 'unavailable')}`,
    `Intent Intake Summary: ${asText(operatorCockpitProjection.intentIntake?.intentSummary, 'unavailable')}`,
    `Intent Intake Desired Outcome: ${asText(operatorCockpitProjection.intentIntake?.operatorDesiredOutcome, 'unavailable')}`,
    `Intent Intake Target Subsystems: ${Array.isArray(operatorCockpitProjection.intentIntake?.targetSubsystems) ? operatorCockpitProjection.intentIntake.targetSubsystems.join(' | ') : asText(operatorCockpitProjection.intentIntake?.targetSubsystems, 'none')}`,
    `Intent Intake Proposed Mission Type: ${asText(operatorCockpitProjection.intentIntake?.proposedMissionType, 'hold')}`,
    `Intent Intake Risk Level: ${asText(operatorCockpitProjection.intentIntake?.riskLevel, 'low')}`,
    `Intent Intake Needs Codex: ${asText(operatorCockpitProjection.intentIntake?.needsCodex, 'no')}`,
    `Intent Intake Needs OpenClaw: ${asText(operatorCockpitProjection.intentIntake?.needsOpenClaw, 'no')}`,
    `Intent Intake Needs Internet Research: ${asText(operatorCockpitProjection.intentIntake?.needsInternetResearch, 'no')}`,
    `Intent Intake Approval Required: ${asText(operatorCockpitProjection.intentIntake?.approvalRequired, 'yes')}`,
    `Intent Intake Confidence: ${asText(operatorCockpitProjection.intentIntake?.confidence, '0.00')}`,
    `Mission Compiler Status: ${asText(operatorCockpitProjection.missionCompiler?.missionCompilerStatus, 'unavailable')}`,
    `Mission Compiler Objective: ${asText(operatorCockpitProjection.missionCompiler?.missionObjective, 'unavailable')}`,
    `Mission Compiler Suggested Route: ${asText(operatorCockpitProjection.missionCompiler?.suggestedRoute, 'hold')}`,
    `Mission Compiler Packet Available: ${asText(operatorCockpitProjection.missionCompiler?.packetAvailable, 'no')}`,
    `Mission Compiler Packet Kind: ${asText(operatorCockpitProjection.missionCompiler?.packetKind, 'none')}`,
    `Mission Compiler Packet Length: ${String((operatorCockpitProjection.missionCompiler?.packetText || '').length)}`,
    `Mission Compiler Approval Required: ${asText(operatorCockpitProjection.missionCompiler?.approvalRequired, 'yes')}`,
    `Mission Compiler Expected Outcome: ${asText(operatorCockpitProjection.missionCompiler?.expectedOutcome, 'unavailable')}`,
    `Reality Research Status: ${asText(operatorCockpitProjection.realityResearchBrief?.realityResearchStatus, 'unavailable')}`,
    `Reality Research Question: ${asText(operatorCockpitProjection.realityResearchBrief?.researchQuestion, 'unavailable')}`,
    `Reality Research Why: ${asText(operatorCockpitProjection.realityResearchBrief?.whyResearchHelps, 'unavailable')}`,
    `Reality Research Approval Required: ${asText(operatorCockpitProjection.realityResearchBrief?.approvalRequired, 'yes')}`,
    `Reality Research Packet Available: ${asText(operatorCockpitProjection.realityResearchBrief?.researchPacketAvailable, 'no')}`,
    `Reality Research Packet Kind: ${asText(operatorCockpitProjection.realityResearchBrief?.researchPacketKind, 'none')}`,
    `Reality Research Packet Length: ${String((operatorCockpitProjection.realityResearchBrief?.researchPacketText || '').length)}`,
    `Reality Research Citation Required: ${asText(operatorCockpitProjection.realityResearchBrief?.citationRequired, 'yes')}`,
    `Reality Research Can Use Web: ${asText(operatorCockpitProjection.realityResearchBrief?.canUseWeb, 'approval-required')}`,
    `Reality Research Mutation Allowed: ${asText(operatorCockpitProjection.realityResearchBrief?.mutationAllowed, 'no')}`,
    `Reality Research Codex Auto Dispatch Allowed: ${asText(operatorCockpitProjection.realityResearchBrief?.codexAutoDispatchAllowed, 'no')}`,
    `Reality Research OpenClaw Mutation Locked: ${asText(operatorCockpitProjection.realityResearchBrief?.openClawMutationLocked, 'yes')}`,
    ...
    `Command Deck Last Diagnostic Packet Detected: ${asText(executionMetadata?.command_deck_last_diagnostic_packet_detected, 'no')}`,
    `Command Deck Last Diagnostic Packet Kind: ${asText(executionMetadata?.command_deck_last_diagnostic_packet_kind, 'none')}`,
    `Command Deck Last Diagnostic Routed To: ${asText(executionMetadata?.command_deck_last_diagnostic_routed_to, 'none')}`,
    `Command Deck Last Diagnostic Response Generated: ${asText(executionMetadata?.command_deck_last_diagnostic_response_generated, 'no')}`,
    `Command Deck Last Diagnostic Active Contradiction: ${asText(executionMetadata?.command_deck_last_diagnostic_active_contradiction, 'no')}`,
    `Command Deck Last Diagnostic Next Action: ${asText(executionMetadata?.command_deck_last_diagnostic_next_action, 'none')}`,
    `Command Deck Last Diagnostic Mutated Proof State: ${asText(executionMetadata?.command_deck_last_diagnostic_mutated_proof_state, 'no')}`,
    `Command Deck Executive Voice Status: ${asText(executionMetadata?.command_deck_executive_voice_status, 'unavailable')}`,
    `Command Deck Executive Voice Response Generated: ${asText(executionMetadata?.command_deck_executive_voice_response_generated, 'no')}`,
    `Command Deck Executive Voice Response Kind: ${asText(executionMetadata?.command_deck_executive_voice_response_kind, 'none')}`,
    `Command Deck Executive Voice Next Move: ${asText(executionMetadata?.command_deck_executive_voice_next_move, 'none')}`,
    `Command Deck Executive Voice Safety Summary Present: ${asText(executionMetadata?.command_deck_executive_voice_safety_summary_present, 'no')}`,
    `Command Deck Executive Voice Uses Canonical State: ${asText(executionMetadata?.command_deck_executive_voice_uses_canonical_state, 'yes')}`,
    `Command Deck Executive Voice Mutation Allowed: ${asText(executionMetadata?.command_deck_executive_voice_mutation_allowed, 'no')}`,
