...
export function buildSupportSnapshot({
  ...
  const lines = [
    ...
    `UI Reality AI Console Nested Operational Pane Count: ${asText(uiRealityStatus.uiRealityAiConsoleNestedOperationalPaneCount, '0')}`,
    `UI Reality AI Console Nested Operational Pane IDs: ${asText(Array.isArray(uiRealityStatus.uiRealityAiConsoleNestedOperationalPaneIds) && uiRealityStatus.uiRealityAiConsoleNestedOperationalPaneIds.length > 0 ? uiRealityStatus.uiRealityAiConsoleNestedOperationalPaneIds.join(', ') : 'none')}`,
    `UI Reality AI Console Nested Operational Pane Titles: ${asText(Array.isArray(uiRealityStatus.uiRealityAiConsoleNestedOperationalPaneTitles) && uiRealityStatus.uiRealityAiConsoleNestedOperationalPaneTitles.length > 0 ? uiRealityStatus.uiRealityAiConsoleNestedOperationalPaneTitles.join(' | ') : 'none')}`,
