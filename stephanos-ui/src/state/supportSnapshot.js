...
export function buildSupportSnapshot({
  ...
  const lines = [
    ...
    `Streaming Mode Preference: ${asText(runtimeStatus?.lastStreamingModePreference, 'off')}`,
    `Streaming Request Source: ${asText(runtimeStatus?.lastStreamingRequestSource, 'off')}`,
