...
export function buildSupportSnapshot({
  ...
  const lines = [
    ...
    `Explanation Intent Detected: ${asText(executionMetadata?.operator_explanation_triggered || executionMetadata?.chat_context_operator_explanation_intent_detected, 'no')}`,
    ...
    `Explanation Projection Used: ${asText(executionMetadata?.operator_explanation_projection_used || executionMetadata?.operator_explanation_triggered, 'no')}`,
