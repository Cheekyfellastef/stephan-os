...
const CANON_RULES = [
  ...
  { id: 'canon.tests_not_ui_proof', text: 'terminal tests alone do not prove visible UI', tags: ['ui', 'proof'] },
...
export function buildChatContextPack(input = {}) {
  ...
  return {
    ...
    recommendedNextAction: uiTask ? 'Capture browser/UI Reality proof before asserting visible fix.' : 'Answer directly with bounded confidence.',
    warnings,
    contextForPrompt: {
      operatorMessage,
      responseMode,
