...
test('V4-V8 roadmap specs are source-owned with V4 browser proof and V5 auto-pick implemented_guarded only', () => {
  ...
  for (const phase of planned) {
    if (phase.version === 'V4' || phase.version === 'V5') assert.equal(phase.status, 'implemented_guarded');
