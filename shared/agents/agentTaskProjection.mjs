...
export function buildAgentTaskProjection({ model = {}, context = {} } = {}) {
  ...
  return {
    ...
    operatorSurface: {
      ...
      openClawValidationFreshness: healthHandshake.validationFreshness || healthHandshake.validation?.validationFreshness || 'unknown',
      openClawValidationRestoredFromStorage: healthHandshake.validationRestoredFromStorage === true,
      openClawValidationLastCheckedAt: healthHandshake.validationLastCheckedAt || healthHandshake.lastHandshakeAt || healthHandshake.lastHealthCheckAt || '',
