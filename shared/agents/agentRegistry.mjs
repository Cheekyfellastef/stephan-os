const DEFAULT_AGENTS = Object.freeze([
  {
    ...
    allowedSurfaces: ['mission-control', 'cockpit', 'agents', 'mission-console'],
    allowedSessionKinds: ['local-dev', 'local-desktop', 'hosted-web', 'local-network'],
  ...
  },
  {
    ...
    allowedSurfaces: ['mission-control', 'agents', 'mission-console'],
    allowedSessionKinds: ['local-dev', 'local-desktop', 'hosted-web', 'local-network'],
    defaultMode: 'manual',
  ...
  },
  {
    ...
    allowedSurfaces: ['mission-control', 'agents', 'mission-console'],
    allowedSessionKinds: ['local-dev', 'local-desktop', 'local-network'],
    defaultMode: 'manual',
    autonomyLevel: 'manual',
    visibility: 'primary',
    enabledByDefault: true,
