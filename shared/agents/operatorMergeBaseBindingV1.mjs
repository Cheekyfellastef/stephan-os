...
/**
 * Decide whether prior operator judgment remains materially reusable after
 * protected main moves. This is a read-only compatibility projection: exact
 * execution receipts and fresh current-head/current-base evidence remain
 * mandatory, and this helper grants no merge authority.
 */
