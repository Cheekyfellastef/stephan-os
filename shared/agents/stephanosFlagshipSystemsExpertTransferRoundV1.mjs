...
const CASES = Object.freeze([
  Object.freeze({ caseId: 'current-system-map', questionClass: 'ARCHITECTURE_AND_RELATIONSHIPS', expectedEvidenceClass: 'CURRENT_SYSTEM_ARCHITECTURE_EVIDENCE', questionText: 'Using live durable truth rather than chat memory, explain the current Stephanos architecture and provider mesh: Mission Scheduler #1556, zero-Codex continuity #1898-#1901, OpenClaw qualification #1657, Forge and Foundry capacity, GitHub construction, optional Codex or Work capacity, Battle Bridge recovery and lifeboat, Ignition #1281 and the integrated provider-neutral Windows Ignition specialist, provider-neutral review, receipts, leases, unattended delivery, sovereignty, Native Research #1902 and Governed Improvement #1903. Separate source admission, runtime truth and consequential operator gates.' }),
...
function buildQuestion(seed, index, roundId, createdAtUtc) {
  const candidate = {
    ...
    contextRefs: ['#1776', '#1308', '#1722', '#1556', '#1290', '#1657', '#1694', '#1281', '#1596', '#1597', '#1898', '#1899', '#1900', '#1901', '#1902', '#1903', '#1934'],
