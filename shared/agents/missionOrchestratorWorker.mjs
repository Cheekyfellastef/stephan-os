...
function blocked(state, reason) {
  return { schemaVersion: 'stephanos.mission-worker-action.v1', actionId: createMissionWorkerActionId(state, 'blocked'), missionId: state.missionId, actionKind: 'blocked', executable: false, blockers: [reason], finalVerdict: 'BLOCKED' };
}
