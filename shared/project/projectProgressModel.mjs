...
const SEEDED_LANES = Object.freeze([
  ...
  createSeedLane({ id: 'launcher-entry', title: 'Launcher Entry', status: 'started', confidence: 0.7, weight: 6, why: 'Launcher entry summaries should remain compact and shared-exported for dashboard/handoff consumption.', evidence: ['shared/project/launcherEntrySummary.mjs', 'modules/command-deck/stephanosTileTruthProjection.mjs'], lastMilestone: 'Launcher compact landing summary projection active.' }),
