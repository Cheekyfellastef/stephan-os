...
function ownerLiveness(owner, options = {}) {
  ...
  // Explicit killFn-only callers retain the deterministic legacy probe used by
  // hosted tests. Production Windows ownership uses PID + process start time.
