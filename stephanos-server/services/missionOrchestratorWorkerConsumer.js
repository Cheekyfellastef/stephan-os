...
async function quarantinePendingPoisonPill(paths, adapter, entry, pendingPath, observedBytes, sourceReason, options = {}) {
  const digest = missionWorkerQueueItemSha256(observedBytes);
